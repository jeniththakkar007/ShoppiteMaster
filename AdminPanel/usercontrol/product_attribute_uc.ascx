...
<div class="white-bg shadow">
    <h4 class="padding15 no-margin">Product Attribute
    </h4>
    ...
    <div class="form-group">
                ...
                <asp:ListView ID="ListView2" runat="server" OnItemDataBound="ListView2_ItemDataBound">
                    ...
                    <ItemTemplate>
                        <div class="col-md-3">
                            ...
                            <h5 class="bold no-margin paadding10">
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn theme-bg white-c margin15 s-bold" OnClick="LinkButton1_Click">Add Attribute in List </asp:LinkButton>
    </div>

    <div class="">

        <div class="checkright grid padding15">
                   ...
                   <asp:Label ID="Label4" runat="server" Text='<%#Eval("Specificationname") %>' CssClass="bold black"></asp:Label>
                            ...
                            <td>
                                <div class=" s-bold">
                                    ...
                                    <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("image") %>' CssClass="pull-right" Width="100px" />
                                </div>
                            </td>
                            <td>
                                <div class="s-bold">
