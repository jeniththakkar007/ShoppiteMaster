...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="padding5">
        <h3 class="bold padding10 no-margin">Script Manager
        </h3>
    </div>
    <div class="row">
            ...
            <table style="width: 100%;">
                ...
                <asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand">
                    <ItemTemplate>
                        <tr>
                            <td>
                                <asp:Label ID="lblid" runat="server" Text='<%#Eval("Scriptid") %>'></asp:Label></td>
                            <td><%#Eval("title") %></td>
                            <td>
                                <asp:LinkButton ID="LinkButton1" runat="server" CommandName="ed" CssClass="edit"></asp:LinkButton></td>
                            <td>
                                <asp:LinkButton ID="LinkButton2" OnClientClick="return confirm('Are you sure you want to delete ?')" runat="server" CommandName="del" CssClass="delete"></asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:ListView>
