...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div class="form border white-bg shadow radius padding15">
     ...
     <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
        ...
        <div class="col-md-9">
            <div class="grid">
                <table style="width: 100%;"><asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand">
                    <ItemTemplate>
                        <tr>
                                 
                   <td> <asp:Label ID="Label1" runat="server" Text='<%# Eval("PageCategoryId") %>'></asp:Label></td>
                <td><asp:Label ID="lblcategoryname" runat="server" Text='<%# Eval("PageCategory1") %>'></asp:Label></td>
                          <td>     <asp:Label ID="lbltype" runat="server" Text='<%# Eval("type") %>'></asp:Label></td>
                     <td>  <asp:Label ID="lblstatus" runat="server" Text='<%# Eval("Status") %>'></asp:Label></td>
                      <td>   <asp:Label ID="lblsortnumber" runat="server" Text='<%# Eval("sortnumber") %>'></asp:Label></td>
                        <td> <asp:LinkButton ID="LinkButton2" CommandName="ed" runat="server" Text="Edit" CssClass="btn btn-xs green-bg white-c"></asp:LinkButton>  <asp:LinkButton ID="LinkButton3" CommandName="del" runat="server" Text="Delete" OnClientClick="return confirm('Are you sure you want to delete ?')" CssClass="btn btn-xs red-bg white-c"></asp:LinkButton></td>
