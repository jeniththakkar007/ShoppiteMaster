...
<table>
    ...
    <asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand">
        <ItemTemplate>
             ...
             <tr> <td>
            <asp:LinkButton ID="LinkButton1" runat="server" CommandName="ed" CausesValidation="False" CssClass="btn btn-success white-c l-bold btn-xs">Edit</asp:LinkButton>  </td>
                 <td>
