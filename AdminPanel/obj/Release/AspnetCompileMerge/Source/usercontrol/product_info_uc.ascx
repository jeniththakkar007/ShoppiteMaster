        ...
        <div class="white-bg padding15 shadow ">
            ...
            <div class="form-group">
                ...
                <div class="dropdown">
                        ...
                        Select Categries 
                        <asp:ListBox ID="ListBox1" runat="server" DataSourceID="SqlDataSource1" DataTextField="catnames" DataValueField="ID"  Height="500px" SelectionMode="Single"></asp:ListBox>
...
<asp:Label ID="lblbrandlist" Visible="false" runat="server" Text=""></asp:Label>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Default %>" ProviderName="<%$ ConnectionStrings:Default.ProviderName %>" SelectCommand="sp_getcat_withoutparent" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
