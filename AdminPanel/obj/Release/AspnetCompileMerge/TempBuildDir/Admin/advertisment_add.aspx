...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
          ...
          <div class="row ">
                ...
                <div class="form-horizontal col-md-6 col-md-offset-3">     <h3 class="bold">Add a new Banner  <small class="pull-right">
...
<h4 class="padding15 no-margin l-yellow-bg">
 Add banner                       
                          ...
                          <div class="form-group">
                              ...
                              <div class="form-group">
                                  Image Size should be <asp:Label ID="Label1" runat="server" Font-Bold="true" Text=""></asp:Label> <br />
            ...
            function UploadFile(fileUpload) {
                if (fileUpload.value != '') {
                    document.getElementById("<%=btnUpload.ClientID %>").click();
                       ...
                       </div>  <asp:Label ID="lblerror" runat="server" CssClass="alert alert-danger padding10 w-100 center" Text=""></asp:Label>
