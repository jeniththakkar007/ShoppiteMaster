...
Account Status (Inactive users cannot login)
   ...
   <asp:Label ID="Label2"  runat="server" Text='<%#Eval("profileid") %>'></asp:Label>
      ...
      <asp:Label ID="Label15" runat="server" Text='<%#Eval("totalproduct_Sold") %>'></asp:Label>
                  ...
                  <td>
      <asp:Label ID="Label4" runat="server" Text='<%#Eval("status") %>'></asp:Label> <br />
                   
        </td>
                 <td>   <asp:LinkButton ID="LinkButton1" CommandName="change" runat="server" CssClass="btn btn-success white-c l-bold btn-xs ">Change Status</asp:LinkButton><br /><br />
