...
{
    private decimal v_standarddeliveryfees = 24;
    private int v_cartlimit = 3;
    private decimal v_cartcost = 0;
    private decimal v_addontax = 2;
    private decimal v_calpercentage = 0;
    private decimal customer_calpercentage = 0;
    private decimal eachpriceqty = 0;
