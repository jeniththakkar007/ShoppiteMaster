            ...
            <div class="col-lg-10 no-padding">
                ...
                <div class="row" style="padding: 10px 0px">
                    ...
                    <div class="col-md-8 nopadding">
                        <h5 class="nomargin"><small>Total Items Found:
                            <asp:Label ID="lbltotalrecords" runat="server" Text="0"></asp:Label></small></h5>
                    </div>
                ...
                <div class="search border radius padding5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 no-padding">
                            <div class="padding5">
                                Price:
                                <asp:TextBox ID="txtpricestart" runat="server" CssClass="border white-smoke-bd" Width="50px"></asp:TextBox>
                                -
                                <asp:TextBox ID="txtpriceend" runat="server" Width="50px" CssClass="border white-smoke-bd"></asp:TextBox>
                            </div>
                        </div>
