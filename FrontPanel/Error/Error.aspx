    ...
    <div class="box-center">
        <div class="confirmation">
            ...
            <h5>
                ...
                <strong>
                    <asp:Label ID="lblerror" runat="server" Text=""></asp:Label></strong>     </h5>
            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn theme-bg black-c" PostBackUrl="~/Default">Exciting Deals are available here</asp:LinkButton>
        </div>
    </div>
</asp:Content>