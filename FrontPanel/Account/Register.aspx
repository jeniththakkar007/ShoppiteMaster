<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="FrontPanel.Account.Register" %>
                        ...
                        <div class="form-horizontal form">
                            ...
                            <div class="form-group" id="vendor" runat="server" visible="false">
                                <div class="input-group">
                                    ...
                                    <ajaxToolkit:FilteredTextBoxExtender ID="txtshopname_FilteredTextBoxExtender" runat="server" BehaviorID="txtshopname_FilteredTextBoxExtender" FilterType="Custom, UppercaseLetters, LowercaseLetters" TargetControlID="txtshopname" ValidChars=" ">
