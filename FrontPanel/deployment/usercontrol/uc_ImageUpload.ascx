...
<span class="pull-right">
 ...
 <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/usernoimage.png" CssClass="radius" Width="100px" /> <br />

</span>
     Photo <br />
    <small class="grey-c visible-lg">
        Follow our guidelines to choose or take a great photo. <br /> 
