...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box-center">
     ...
     <strong>  Order # <asp:Label ID="lblorder" runat="server" Text="Label"></asp:Label></strong>  has been placed successfully and an invoice has been emailed to you.     </h5>
              ...
              <div class="col-md-11 o-padding"> 
               <div class="pull-right">
                   ...
                   <div class="number">
                     ...
                     QTY  <asp:Label ID="Label3" runat="server" Text='<%#Eval("qty") %>' CssClass="bold"></asp:Label>
                        ...
                        <table style="width: 100%;">
                            <tr>
                              ...
                              <tr>
                               ...
                               <td > <asp:Label ID="Label4" runat="server" Text="Shipping:"></asp:Label></td>
                                <td> <asp:Label ID="Label5" runat="server" Text='<%#Eval("shipping") %>' CssClass="fonts black-c s-bold"></asp:Label> <%#Eval("currencyname") %> </td> 
                                  </tr>

                               <tr>
                                   
                                 <td > <asp:Label ID="Label6" runat="server" Text="Vat:"></asp:Label></td>
                                <td> <asp:Label ID="Label7" runat="server" Text='<%#Eval("vat") %>' CssClass="fonts black-c s-bold"></asp:Label> <%#Eval("currencyname") %></td>
                                   </tr>
                             
                               <tr>

                                 <td > <asp:Label ID="Label8" runat="server" Text="Tax:"></asp:Label></td>
                                <td> <asp:Label ID="Label9" runat="server" Text='<%#Eval("Tax") %>' CssClass="fonts black-c s-bold"></asp:Label><%#Eval("currencyname") %></td>
