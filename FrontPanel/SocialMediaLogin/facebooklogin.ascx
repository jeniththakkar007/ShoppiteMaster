...
<asp:LinkButton ID="LinkButton1" runat="server" OnClick="FacebookLogin">
    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/l-facebook.png" Width="55px" /></asp:LinkButton>
