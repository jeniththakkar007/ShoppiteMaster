        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form noshadow noborder">
                    ...
                    <asp:Label ID="Label1" runat="server" Text="Post Review" CssClass="bold"></asp:Label>
                    <ajaxToolkit:Rating ID="Rating1" runat="server" StarCssClass="ratingEmpty" WaitingStarCssClass="ratingSaved" EmptyStarCssClass="ratingEmpty" FilledStarCssClass="ratingFilled" CurrentRating="3" CssClass="pull-right"></ajaxToolkit:Rating>
                    <br />
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox><br />
                    <asp:Button ID="Button1" runat="server" Text="Post" CssClass="btn btn-black" OnClick="Button1_Click" /><br />
                    <br />
                </div>
            </div>
        </div>
