...
<div id="dvCookieMessage" style="display: none;">
    <div>
        <p>
            We use cookies to improve and personalise your browsing experience, to perform analytics and research, and to provide social media features. By continuing to use our site, you accept our

            <a href="#PolicyURL">cookie and Privacy policy</a>.
        </p>
