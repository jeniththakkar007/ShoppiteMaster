...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <br />
        <h4 class="no-margin padding5">Top Fundraisers
        </h4>
        <br />
        <div class="row">
                        ...
                        <div class="border radius">
                            ...
                            <div class="padding10">
                                ...
                                <p>
                                    ...
                                    <strong>
                                        <asp:Label ID="Label1" runat="server" Text='<%#Eval("totalreceived") %>'></asp:Label>
                                        raised
                                    </strong>of
                                    <asp:Label ID="Label4" runat="server" Text='<%#Eval("Amount") %>'></asp:Label>
                                    <asp:LinkButton ID="LinkButton2" CommandName="pay" runat="server" Text="Donate" CssClass="btn btn-xs theme-bg pull-right f-theme"></asp:LinkButton>
                                </p>
                            </div>
                        </div>
