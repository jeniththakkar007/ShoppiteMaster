        ...
        <div class="container">
            <div class="form-center no-form-center row">
                ...
                <div class="col-md-6">
                    ...
                    <h2 class="bold">Donate To Our <span class="theme-c">Community Fund</span>
                    </h2>
                    <br>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="left form marginrf-15">
                                        ...
                                        <div>
                                            ...
                                            <h4 class="margin10 paddingtb-15 bold">Total Donation :   <span class="theme-c">

                                                <asp:Label ID="lblcurrency" runat="server"></asp:Label>
                                                <asp:Label ID="lblamount" runat="server" Text="0"></asp:Label></span>
                                            </h4>
                                        </div>
                                    </div>
                                </ContentTemplate>
            ...
            Donate</asp:LinkButton>
                            ...
                            <div role="tabpanel" class="tab-pane" id="profile">
                                ...
                                <div class="form marginrf-15 donation">
                                    <uc1:stripe_uc runat="server" ID="stripe_uc" />
                                </div>
                                <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" CssClass="btn marginrf-15  theme-bg btn-lg f-theme bold radius30" Width="185px">Donate</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
