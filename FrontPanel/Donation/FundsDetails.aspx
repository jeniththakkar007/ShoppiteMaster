        ...
        <div class="row">
            ...
            <div class="col-md-4 padding15">
                <div class="white-bg border radius padding15">
                    <h3 class="bold">Donation summury
                    </h3>
                    <hr />
                    <h5>Amount:      <strong class="pull-right fonts ">
                        <asp:Label ID="lblamount" runat="server" Text="Label"></asp:Label>
                        <asp:Label ID="lblcurrency" runat="server" Text="Label"></asp:Label>
                    </strong>
                    </h5>
                    <hr />
                    <h5>Amount Received:   <strong class="pull-right fonts ">
                        <asp:Label ID="lblamountreceived" runat="server" Text="Label"></asp:Label>
                    </strong>
                    </h5>
                    <hr />

                    <h5>Balance Needed:   <strong class="pull-right fonts ">
                    ...
                    <h5>Campaign Start Date:   <strong class="pull-right fonts ">
                        <asp:Label ID="lblcampaignstartdate" runat="server" Text="Label"></asp:Label>
                    </strong>
                    </h5>
                    <hr />
