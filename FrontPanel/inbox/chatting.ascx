<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="chatting.ascx.cs" Inherits="FrontPanel.inbox.chatting" %>
                    ...
                    <p class="grey-c">
                        ...
                        <asp:Panel ID="Panel2" runat="server" Visible="false">
                            <div class=" white-bg padding10 line-h shadow">
                                <h4 class="bold black-c">New Custome Offer
                                    <asp:Label ID="lblofferstatus" runat="server" Text="" Visible="true" CssClass="label label-danger" Font-Size="10px"></asp:Label>
                                    <asp:Label ID="lblfees" runat="server" Text="" CssClass="pull-right"></asp:Label>
                                </h4>
                                <hr class="margin5" />

                                <asp:Label ID="lbldescription" runat="server" Text=""></asp:Label>
                                <span class="pull-right center">
                                    <i class="far fa-clock theme-c"></i>
                                    ...
                                    <asp:LinkButton ID="lnkwithdraw" Text="With Draw Offer" runat="server" CommandName="withdraw" CssClass="btn blue-bg white-c btn-xs"></asp:LinkButton>
                                </span>
                                <br />
                                <br />
                            </div>
