       ...
       <div class="col-lg-2 padding5 m-none">
        <div class="border radius padding10 form">
           ...
           Catgeories
            ...
            <asp:Button ID="Button1" runat="server" Text="Search" CssClass="padding5" OnClick="Button1_Click" /> <br />
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 padding5">
                                 ...
                                 <div class="white-bg radius padding5 shadow-hover border radius"> 
                                    ...
                                    <div class="padding5">
                                       ...
                                       <%#Eval("ShopName") %> <br />
                                            <small>
                                        Total Product: <asp:Label ID="Label1" runat="server" Text='<%#Eval("totalproducts") %>' CssClass="bold "></asp:Label>
