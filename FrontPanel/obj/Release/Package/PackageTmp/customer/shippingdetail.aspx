    ...
    <div class="white-bg ">
      ...
      <div class="white-bg radius padding15 form">
          ...
          <hr />
                    ...
                    <uc1:uc_shipping runat="server" ID="uc_shipping" />    </div> 
                    <br />
                    <br />
                     <div class="white-bg radius padding15 form">
          <h4>
                        ...
                        <table style="width: 100%;">
                              ...
                              <tr>
                               ...
                               <tr>
                                ...
                                <td class="fonts red-c bold"> <asp:Label ID="Label1" runat="server" Text='<%#Eval("Total") %>' ></asp:Label>  <%#Eval("currencyname") %></td> 
