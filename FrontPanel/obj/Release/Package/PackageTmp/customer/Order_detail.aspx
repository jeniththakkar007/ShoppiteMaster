<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Order_detail.aspx.cs" Inherits="FrontPanel.Admin.Order_detail" %>
...
<div class="container">
      <div class="paddingtb-15 ">
        <div class="row ">
            <div class="col-md-8 border padding15 ">
                ...
                <div class="white-bg padding15">  
                    <h4 class="bold upp">
  Order # <asp:Label ID="lblorderid" runat="server" Text=""></asp:Label>
        </h4>
                    <br />
                        ...
                        <tr class="padding10">
                          ...
                          <tr class="padding10">
                            <td>Order Status</td>
                            <td> <asp:Label ID="lblorderstatus" runat="server" Text="Pending" CssClass="bold"></asp:Label></td>
    ...
    <asp:ListView ID="ListView1" runat="server" >
                                    ...
                                    <ItemTemplate>    <asp:Label ID="Label11" runat="server" Text='<%# Eval("id") %>' Visible="false"></asp:Label>
                                        ...
                                        <table style="width:100%; border:solid 1px #eee; padding:10px;">
                                            <td style="width:50%">
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td>   <asp:Image ID="Image1" runat="server" Height="80px" Width="80px"  ImageUrl='<%# Eval("image") %>' CssClass=" padding5" />
     </td>
                                                        <td> <h5>
    ...
    <span class="bold">
        <asp:Label ID="Label5" runat="server" Text='<%# Eval("orderdeliverystatus") %>' CssClass=""></asp:Label> :
                                                       <asp:Label ID="Label10" runat="server" Text='<%# Eval("orderdeliverystatusdate") %>' CssClass="m-bold"></asp:Label></span>     <br />
...
<table style="width: 100%;">
                                                    <tr>
                                                        ...
                                                        <td> <asp:Label ID="Label13" runat="server" Text='<%# Eval("CurrencyName") %>'></asp:Label>
                                                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("Price") %>'></asp:Label></td>
                                                    
                                                    </tr>
                                                    <tr>
                                                        <td>Shipping</td>
                                                        <td> <asp:Label ID="Label18" runat="server" Text='<%# Eval("CurrencyName") %>'></asp:Label>
                                                        <asp:Label ID="Label19" runat="server" Text='<%# Eval("deliveryfees") %>'></asp:Label></td>
                                                      
                                                    </tr>
                                                    <tr>
                                                        <td>Vat</td>
                                                        <td><asp:Label ID="Label20" runat="server" Text='<%# Eval("CurrencyName") %>'></asp:Label>
  ...
  <asp:Label ID="lbltotal" runat="server" Text="0" CssClass="red-c"></asp:Label>
                    ...
                    <table style="width: 100%;">
                        <tr class="padding10">
                             ...
                             <td style="vertical-align:top;"><asp:Label ID="lblshipping" runat="server" Text=""></asp:Label></td>
            ...
            <div class="col-lg-3 col-sm-4">
                <div class="white-smoke-bg padding15 border radius ">
                    <h4>
               ...
               <asp:RadioButtonList ID="RadioButtonList1"  runat="server">
                ...
                <asp:TextBox ID="txtreason" runat="server" TextMode="MultiLine"></asp:TextBox>
                 <asp:RequiredFieldValidator runat="server" ControlToValidate="txtreason"
                                CssClass="required" ErrorMessage="Field is Required." SetFocusOnError="True" ValidationGroup="camcel" />
                     </div>
                 <div class="form-group">
                     <asp:Button ID="Button1" runat="server" ValidationGroup="camcel" Text="Send Request" OnClick="Button1_Click" CssClass="padding10 s-bold upp" />
                     </div>
            </div>
                </div>
            </div></div>
