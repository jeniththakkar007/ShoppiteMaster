...
<asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand">
        <ItemTemplate>
             ...
             <div class="row">   <asp:Label ID="Label2" Visible="false" runat="server" Text='<%#Eval("RequestFundGUID") %>'></asp:Label>
 ...
 <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("Image") %>'  />
       ...
       <span class="pull-right">    
                     <asp:LinkButton ID="LinkButton2" CommandName="ed" runat="server" CssClass="btn btn-default btn-xs grey-c padding5"> <i class="fas fa-pencil-alt fa-lg"></i>  </asp:LinkButton>   </span> 
                     
  <asp:Label ID="Label3" runat="server" Text='<%#Eval("Title") %>'></asp:Label>  </h5> 
     <asp:Label ID="Label4" runat="server" Text='<%#Eval("Amount") %>' CssClass="bold"></asp:Label>   &nbsp; - &nbsp;   <asp:Label ID="Label5" runat="server" Text='<%#Eval("InsertDate") %>'></asp:Label>                    
