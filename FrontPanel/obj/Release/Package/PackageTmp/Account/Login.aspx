<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="FrontPanel.Account.Login" Async="true" %>
       ...
       <asp:Image ID="Image1" runat="server" ImageUrl="~/images/envelop.png" Height="15px" />
                    ...
                    <div class="form-group">
                            ...
                            <div class="checkbox">
                             ...
                             <asp:LinkButton ID="LinkButton1" runat="server" CssClass="c-green-c pull-right" CausesValidation="False" PostBackUrl="~/Account/Forgot.aspx">Forgot Password</asp:LinkButton>  </div>
                ...
                <h5 class="right">
                Don’t have an account?   <asp:HyperLink runat="server" ID="RegisterHyperLink" ViewStateMode="Disabled" CssClass="c-green-c bold">Sign up</asp:HyperLink>
                </h5>
