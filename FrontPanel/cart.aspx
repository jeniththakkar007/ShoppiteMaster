...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="white-bg ">
        <div class="container">
            <h4 class="padding15">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/cart.png" Width="25px" />
                Shopping Cart
            </h4>
        </div>
    </div>
                                            ...
                                            <div class=" paddingrf-15 pull-right">
                                                ...
                                                <table style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="Label3" runat="server" Text="Shipping:"></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="Label4" runat="server" Text='<%#Eval("shipping") %>' CssClass="fonts black-c s-bold"></asp:Label>
                                                            <%#Eval("currencyname") %> </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="Label5" runat="server" Text="Vat:"></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="Label6" runat="server" Text='<%#Eval("vat") %>' CssClass="fonts black-c s-bold"></asp:Label>
                                                            <%#Eval("currencyname") %></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="Label7" runat="server" Text="Tax:"></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="Label8" runat="server" Text='<%#Eval("Tax") %>' CssClass="fonts black-c s-bold"></asp:Label><%#Eval("currencyname") %></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
