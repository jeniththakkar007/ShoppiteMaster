<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="allmessages.ascx.cs" Inherits="VendorPanel.inbox.allmessages" %>
...
<asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand" OnItemDataBound="ListView1_ItemDataBound" DataSourceID="SqlDataSource1">
 ...
 <asp:Label ID="Label1" runat="server" Text='<%# Eval("chatid") %>' Visible="false"></asp:Label> <br />
                  ...
                  <%--    <asp:Label ID="Label4" runat="server" Text='   <%# string.IsNullOrEmpty(Eval("shopname").ToString())?  String.Empty : "Guest" %>' ></asp:Label>--%>
