<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="product_Images_uc.ascx.cs" Inherits="VendorPanel.usercontrol.product_Images_uc" %>
...
<div class="row form-group">
               ...
               <div class="col-md-6">Display order
