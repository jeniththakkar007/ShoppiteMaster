<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MyOrders.aspx.cs" Inherits="VendorPanel.customer.MyOrders" %>
                        ...
                        <div class="white-bg border white-bd ">
                            ...
                            <a class="showBtn" href="#">
                                <div class="row padding5">
                                    <h5 class="line20 row">
                                        <div class="col-xs-8">
                                            Order ID: <span class="c-green-c">#<asp:Label ID="Label6" runat="server" Text='<%# Eval("orderid") %>'></asp:Label>
                                            </span>
                                            <br />
                                            <small>Placed on
                                                <asp:Label ID="Label8" runat="server" Text='<%# Eval("orderdate" , "{0:MMM-dd-yyyy}") %>'></asp:Label>
                                            </small>
                                        </div>
                            ...
                            <div class="hideme">
                                <asp:ListView ID="ListView2" runat="server" DataSourceID="SqlDataSource1" OnItemCommand="ListView2_ItemCommand">
                                        ...
                                        <div class="row border">
                                            ...
                                            <div class="col-md-5 ">
                                                ...
                                                <div class="col-xs-6 nopadding">
                                                    ...
                                                    <span class="badge m-bold margin10 padding5 white-smoke-bg black-c upp pull-right">
                                                ...
                                                <div class="col-xs-6 ">
                                                    <div class="pull-right dropdown">
                                                        ...
                                                        <div class="dropdown-content">
                                                            <h6 class="line20">
                                                                <span class="black-c bold">Change the Order Status:</span><br>
                                                                <a class="red-c">Click    </a>
                                                                <small>to change the order status</small>
                                                            </h6>
                                                        </div>
                                                    </div>
                                ...
                                <div class="margin15 border radius white-smoke-bg padding10 row">
                                    ...
                                    <div class="col-md-4 right">
                                        <h5><small>Payment Mode:
                                            <asp:Label ID="Label16" runat="server" Text='<%# Eval("PaymentMode") %>' CssClass="d-grey-c bold"></asp:Label></small> &nbsp;
                                            <br />
                                            &nbsp;   <small>Payment Date:
                                                <asp:Label ID="Label17" CssClass="d-grey-c bold" runat="server" Text='<%# Eval("PaymentDate" , "{0:MMM-dd-yyyy}") %>'></asp:Label>
                                            </small></h5>
                                        <br />
                                        <h4>Total Amount:
                                            <br />

                                            <strong class="orange-c">
                                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("totalPrice","{0:#,##0.00}") %>'></asp:Label>
                                                <%# Eval("CurrencyName") %></strong>
                                        </h4>
                                    </div>
                                </div>
  ...
  if ($(this).hasClass('active')) {
    ...
    <div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm c-shadow  white-bg">
            ...
            <h3 class="bold no-margin ">Order Status
                <br />
                <small>
                    <a runat="server" href="~/1/Help-Center/page">Click to read our terms and Condition</a>
                </small>
            </h3>
            <hr />
