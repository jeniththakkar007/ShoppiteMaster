                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div class="row border" >  
                                            ...
                                            <div class="col-md-5 ">
                                                ...
                                                <span class="badge m-bold margin10 padding5 white-smoke-bg black-c upp pull-right"><asp:Label ID="Label5" runat="server" Text='<%# Eval("orderdeliverystatus") %>' CssClass=""></asp:Label> :
     ...
     <small>to change the order status</small>
                                ...
                                <div class="margin15 border radius white-smoke-bg padding10 row">
                                    ...
                                    <div class="col-md-4 right"> 
                                         <h5><small> Payment Mode:  <asp:Label ID="Label16" runat="server" Text='<%# Eval("PaymentMode") %>' CssClass="d-grey-c bold"></asp:Label></small> &nbsp;  <br /> &nbsp;   <small>  Payment Date: <asp:Label ID="Label17"  CssClass="d-grey-c bold" runat="server" Text='<%# Eval("PaymentDate" , "{0:MMM-dd-yyyy}") %>'></asp:Label> </small> </h5>  
               <br />
                                        <h4>
...
.dropdown:hover .dropdown-content {display: block;}
    ...
    <div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm c-shadow  white-bg">
            ...
            <h3 class="bold no-margin ">Order Status <BR />
            <small>
