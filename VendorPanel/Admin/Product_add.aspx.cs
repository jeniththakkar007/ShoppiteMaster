...
namespace VendorPanel.Admin
{
    public partial class Product_add : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (Request.QueryString["ID"] != null)
                {
                    ...
                    if (pb != null)
                    {
                        ...
                        {
                            int brandid = int.Parse(productbrands.BrandId.ToString());

                            product_info_uc.ProductBasic_txtbrand = b.getbrandname(brandid);
                        }
        ...
        protected void brandinsert(Guid id)
        {
            ...
            Product_Brands pb = db.Product_Brands.FirstOrDefault(u => u.ProductGUID == id);
            ...
            if (pb == null)
            {
                ...
                productbrands.BrandId = b.getbrandid(product_info_uc.ProductBasic_txtbrand);
            ...
            {
                pb.ProductGUID = id;
                pb.BrandId = b.getbrandid(product_info_uc.ProductBasic_txtbrand);
                pb.InsertDate = DateTime.Now;
                pb.UserName = this.Page.User.Identity.Name;
