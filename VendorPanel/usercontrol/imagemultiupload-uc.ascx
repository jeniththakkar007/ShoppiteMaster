<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="imagemultiupload-uc.ascx.cs" Inherits="FrontPanel.usercontrol.imagemultiupload_uc" %>
...
<div class="white-bg shadow">
    <h4 class="padding15 no-margin">Other Images of Product
    </h4>
