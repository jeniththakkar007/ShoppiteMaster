<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="seo_uc.ascx.cs" Inherits="VendorPanel.usercontrol.seo_uc" %>
...
<div class="white-bg shadow">
   ...
   <asp:TextBox ID="txtpagename" runat="server"></asp:TextBox>
                     ...
                     </div><div class="form-group "> Meta title
...
Meta keywords
                     ...
                     </div>  <div class="form-group ">Meta description 
